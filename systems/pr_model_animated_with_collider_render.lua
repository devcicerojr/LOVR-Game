...
return {
  phase = "render",
  requires = { "model" , "animated", "transform", "tracks_collider"},
  update_fn = function(id , c , pass) -- draw function
    ...
    if entity.animated.cur_animation_idx > 0 then
      cur_animation = entity.model.model:getAnimationName(entity.animated.cur_animation_idx)
